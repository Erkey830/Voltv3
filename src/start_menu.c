...
{
    .tileTag = TAG_ICONS_MENU, //LUGAR DONDE SE CARGA EL GRÃFICO ----------
    .paletteTag = TAG_ICONS_MENU, //LUGAR DONDE SE CARGA LA PALETA ----------
    .oam = &gSpriteOamData32, //OAM DATA DEL ICONO ----------
    .anims = sAnimsIconMenu, //TABLA DE ANIMACIÃ“N DEL ICONO ---------- 
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable, 
    .callback = SpriteCallbackDummy, //ANIMACIÃ“N DEL ICONO ----------
};
